...
def main():
    ...
    play._theme.widget_font_size = 25
    play._theme.widget_font_color = BLACK 
    play._theme.widget_alignment = pm.locals.ALIGN_LEFT 
    ...
    mainMenu.add.button(title="игры", action=play, font_color=WHITE, background_color=GREEN, align=pm.locals.ALIGN_CENTER)
    ...
    mainMenu.add.button(title="выйти", action=pm.events.EXIT, 
